...
if (isset($_POST['add'])) {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO patient (firstName, lastName, userName, email, PhoneNo, password, insuranceDetails, insuranceCover, gender)
                VALUES ('$firstName', '$lastName', '$userName', '$email', '$PhoneNo', '$password','$insuranceDetails', '$insuranceCover', '$gender')";
    ...
    <div class="container">
        <div class="form-section">
            ...
            <form action="" method="POST">
                ...
                <input type="text" name="insuranceDetails" id="insuranceDetails" required><br>

                <label for="insuranceCover">insurance Cover:</label><br>
                <input type="text" name="insuranceCover" id="insuranceCover" required><br>
                <div class="radio">
